...
Sub SendRequest5()
    ...
    Else
        ...
        oRequest.Body = oRequest.Body + "&txtBoxUserID=a123&txtBoxPassword=1123&btnLo"
...
Sub SendRequest6()
    ...
    Else
        ...
        oHeaders.Add "Content-Length", "(automatic)" 
        oRequest.Body = "__VIEWSTATE=" & strViewState
        oRequest.Body = oRequest.Body + "&txtBoxUse"
...
Sub SendRequest15()
    ...
    Else
        ...
        oRequest.Body = oRequest.Body + "&DevType=rbTerminal&txtboxLNIATA=&txtb"
...
Sub SendRequest16()
    ...
    Else
        ...
        oHeaders.Add "Content-Length", "(automatic)" 
        oRequest.Body = "__EVENTTARGET=&__EVENTARGUMENT=&__VIEWSTATE=" & strViewState
        oRequest.Body = oRequest.Body + "&DevType=rbTerminal&txtboxLNIATA=abc123&"
