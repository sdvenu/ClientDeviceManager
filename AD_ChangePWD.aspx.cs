...
namespace ClientDeviceMgr
{
	...
	/// </summary>
	public partial class AD_ChangePWD : Web.PageBase
	{
		...
		protected void btnResetPwd_Click(object sender, System.EventArgs e)
		{
			...
			if (myDS == null)
			{
				MainMsg.Text = "Could not access the database, try again.";
				MainMsg.ForeColor = System.Drawing.Color.Red;
				return;
			}
			...
			{
                MainMsg.Text = "The User could not be found, try again.";
                MainMsg.ForeColor = System.Drawing.Color.Red;
				return;
			}

			string Updatecommand =
                "UPDATE " + MANAGEMENT_RIGHTS_TBL +
