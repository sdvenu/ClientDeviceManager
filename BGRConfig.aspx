<%@ Page language="c#" Codebehind="BGRConfig.aspx.cs" AutoEventWireup="True" Inherits="ClientDeviceMgr.BGRConfig" %>
		...
		<form id="BGRConfigForm" method="post" runat="server">
			...
			<TABLE id="Table1" style="Z-INDEX: 102; LEFT: 208px; WIDTH: 664px; POSITION: absolute; TOP: 128px; HEIGHT: 220px"
				...
				<TR>
					...
					<TD style="WIDTH: 82px">
						<asp:TextBox id="txtboxNumBGRs" runat="server" Width="72px" MaxLength="2" ToolTip="The value entered here should represent the number of BGR devices attached to this workstation.">1</asp:TextBox></TD>
					<TD style="WIDTH: 182px">
						<asp:Label id="Label3" runat="server" Font-Bold="True" ForeColor="Navy" Font-Size="Smaller">Airline ID</asp:Label></TD>
					<TD>
						<asp:TextBox id="tbAirlineId" runat="server" Width="32px" AutoPostBack="True" ontextchanged="tbAirlineId_TextChanged">AA</asp:TextBox></TD>
				</TR>
				<TR>
					<TD style="WIDTH: 217px">
					...
					<TD style="WIDTH: 82px">
						<asp:TextBox id="txtboxHostSys" runat="server" Width="72px" MaxLength="8" ToolTip="This is the default system in the host the application will work from. (i.e. RES or DECS)">RES</asp:TextBox></TD>
					<TD style="WIDTH: 182px">
						<asp:CheckBox id="cbTesting" runat="server" Font-Bold="True" ForeColor="Navy" Text="Testing" Font-Size="Smaller"></asp:CheckBox></TD>
					<TD></TD>
				</TR>
				<TR>
					<TD style="WIDTH: 217px; HEIGHT: 21px">
						<asp:CheckBox id="ckboxLogging" runat="server" Font-Bold="True" ForeColor="Navy" ToolTip="If this is enabled then the BGR Application screen logger will activate when the BGR Application launches. This should not be activated by default and should only be used for debugging or troubleshooting purposes."
							Text="Application Logger Active" Font-Size="Smaller"></asp:CheckBox></TD>
					...
					<TD style="WIDTH: 182px; HEIGHT: 21px">
						<asp:CheckBox id="cbDebugWindow" runat="server" Font-Bold="True" ForeColor="Navy" Text="Debug Window"
							Font-Size="Smaller"></asp:CheckBox></TD>
				...
				<TR>
					<TD style="WIDTH: 217px">
						<asp:CheckBox id="ckboxHostVal" runat="server" Font-Bold="True" ForeColor="Navy" ToolTip="This forces the application to await the repsonse from the host before completing the transaction. This will hurt performance and should be used with caution."
							Text="Host Validation Mode" Font-Size="Smaller" Checked="True"></asp:CheckBox></TD>
					<TD style="WIDTH: 82px"></TD>
					<TD style="WIDTH: 182px">
						<asp:Label id="Label4" runat="server" Font-Bold="True" ForeColor="Navy" Font-Size="Smaller">Host Receive Timeout</asp:Label></TD>
					<TD>
						<asp:TextBox id="tbHostReceiveTimeout" runat="server" Width="56px" MaxLength="6">60</asp:TextBox>
				...
				<TR>
					<TD style="WIDTH: 217px">
						<asp:CheckBox id="ckboxNOLED" runat="server" Font-Bold="True" ForeColor="Navy" ToolTip="This should only be checked when the device does not have an LED display to render information messages to the agent."
							Text="No LED display on the BGR device" Font-Size="Smaller"></asp:CheckBox></TD>
					<TD style="WIDTH: 82px"></TD>
					<TD style="WIDTH: 182px">
						<asp:Label id="Label5" runat="server" Font-Bold="True" ForeColor="Navy" Font-Size="Smaller">Host Update Interval</asp:Label></TD>
					<TD>
						<asp:TextBox id="tbHostUpdateInterval" runat="server" Width="56px" MaxLength="6">30000</asp:TextBox>
				...
				<TR>
					<TD style="WIDTH: 217px">
						<asp:CheckBox id="ckboxSCEdit" runat="server" Font-Bold="True" ForeColor="Navy" Text="Enable SC Edit Check"
							Font-Size="Smaller" Checked="True"></asp:CheckBox></TD>
					<TD style="WIDTH: 82px"></TD>
					<TD style="WIDTH: 182px">
						<asp:Label id="Label6" runat="server" Font-Bold="True" ForeColor="Navy" Font-Size="Smaller">Inactivity Interval</asp:Label></TD>
					<TD>
						<asp:TextBox id="tbInactivityInterval" runat="server" Width="32px" MaxLength="2">15</asp:TextBox>
				...
				<TR>
					...
					<TD>
						<asp:TextBox id="tbMaxLogDataSize" runat="server" Width="32px" MaxLength="3">10</asp:TextBox>
				...
				<TR>
					...
					<TD>
						<asp:TextBox id="tbBGR1PortName" runat="server" Width="48px" MaxLength="4">COM1</asp:TextBox></TD>
				</TR>
				<TR>
					<TD style="WIDTH: 217px">
					...
					<TD>
						<asp:TextBox id="tbBGR2PortName" runat="server" Width="48px" MaxLength="4"></asp:TextBox></TD>
				</TR>
				<TR>
					...
					<TD>
						<asp:TextBox id="tbBGR3PortName" runat="server" Width="48px" MaxLength="4"></asp:TextBox></TD>
				</TR>
				<TR>
					<TD style="WIDTH: 217px"></TD>
					<TD style="WIDTH: 82px"></TD>
					...
					<TD>
						<asp:TextBox id="tbBGR4PortName" runat="server" Width="48px" MaxLength="4"></asp:TextBox></TD>
				</TR>
				<TR>
					<TD style="WIDTH: 217px"></TD>
					<TD style="WIDTH: 82px">
						<asp:Button id="btnOK" runat="server" Width="64px" Text="OK" onclick="btnOK_Click"></asp:Button></TD>
					<TD style="WIDTH: 182px">
