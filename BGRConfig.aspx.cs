...
namespace ClientDeviceMgr
{
	...
	/// </summary>
	public partial class BGRConfig : Web.PageBase
	{
		...
		private string WebForm = "BGRConfig";
		...
		protected void btnOK_Click(object sender, System.EventArgs e)
		{
			...
			actcmd="";
			for(int k=0;k<insertcommand.Length;k++)
			{
				if (insertcommand[k] != '\'')
					actcmd += insertcommand[k];
			}
			...
			actcmd="";
			for(int k=0;k<updatecmd.Length;k++)
			{
				if (updatecmd[k] != '\'')
					actcmd += updatecmd[k];
			}
		...
		protected void tbAirlineId_TextChanged(object sender, System.EventArgs e)
		{
			...
			//			ckboxSCEdit.Enabled = enableFlag;
			//			ckboxProfileChk.Enabled = enableFlag;
			//			ckboxAddCollect.Enabled = enableFlag;
		}
