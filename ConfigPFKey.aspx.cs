...
namespace ClientDeviceMgr
{
	...
	/// </summary>
	public partial class ConfigPFKey : Web.PageBase
	{
		...
		private string WebForm = "ConfigPFKey";
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			String []myScript = 
			{
				...
				"	}",
				"	Form1.TextBoxNewCmd.value=newString;",
				"}",
				"</script>"
			};
			String scriptString="";
		...
		private void GetDataForPFKey( int nPFKey )
		{
			if( nPFKey >= 1 && nPFKey <= 24 )
			{
				...
				TextBoxNewCmd.Text = TextBoxCommand.Text;
		...
		private void StoreToPFKey( int nPFKey )
		{
			...
			pfKeys[nPFKey].SetPFKeyCommand(TextBoxNewCmd.Text);
		}
		...
		{
			String userId = TextBoxUser.Text.ToUpper().Trim();
		...
		private void logAudit(string cmd, int complete)
		{
			...
			string logcmd = "INSERT INTO AuditLogtbl(UserName,UserID,commandStr,WebForm," +
				...
				(string)Session["USER_ID"] +"','" + cmd + "','" +WebForm + "','" + UserIP + 
				"','" + HostName +	"','" + complete +"')";
