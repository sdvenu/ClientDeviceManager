<%@ Page language="c#" Codebehind="ConfigPtrAEALiteDrv.aspx.cs" AutoEventWireup="True" Inherits="ClientDeviceMgr.ConfigPtrAEALiteDrv" %>
...
<HTML>
	<HEAD>
		<title>ConfigPtrAEALiteDrv</title>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table3" style="Z-INDEX: 106; LEFT: 720px; WIDTH: 257px; POSITION: absolute; TOP: 128px; HEIGHT: 272px"
				...
				<TR>
					<TD><asp:label id="Label3" runat="server" Font-Bold="True">Maximum size of Log File in Bytes</asp:label><asp:textbox id="textBoxMaxFileSize" runat="server" Width="120px" MaxLength="7" ontextchanged="textBoxMaxFileSize_TextChanged"></asp:textbox></TD>
				</TR>
			</TABLE>
			<asp:panel id="Panel3" style="Z-INDEX: 104; LEFT: 208px; POSITION: absolute; TOP: 400px" runat="server"
				...
				<P>
					<asp:DropDownList id="ddlIoDriver" runat="server">
						<asp:ListItem Value="PORTS.DLL">PORTS.DLL</asp:ListItem>
					</asp:DropDownList></P>
				<P>
					<asp:CheckBox id="cbDopPPCCTC" runat="server" Text="Remove PC(Pectab Clear) and CT(Change Transaction) data"
				...
				<P>
					<TABLE id="Table1" style="WIDTH: 440px; HEIGHT: 36px" cellSpacing="1" cellPadding="1" width="440"
						...
						<TR>
							...
							<TD>
								<asp:RadioButton id="rbDisabled" runat="server" Text="Disabled" AutoPostBack="True" Width="192px" oncheckedchanged="rbDisabled_CheckedChanged"></asp:RadioButton></TD>
						</TR>
					</TABLE>
				</P>
			</asp:panel>
				...
				<TABLE id="Table2" style="WIDTH: 504px; HEIGHT: 96px" cellSpacing="1" cellPadding="1" width="504"
					...
					<TR>
						<TD style="WIDTH: 146px; HEIGHT: 80px" vAlign="top">
							...
							<P>&nbsp;
								<asp:TextBox id="textboxNoOfFF" runat="server" Width="40px" MaxLength="1">0</asp:TextBox>&nbsp;&nbsp;</P>
						</TD>
							...
							<P>
								<TABLE id="Table7" style="WIDTH: 168px; HEIGHT: 128px" cellSpacing="0" cellPadding="0"
									...
									<TR>
										<TD>
											<P>
												<asp:CheckBox id="cbInsertLFAfterCR" runat="server" Text="Insert LF/After CR" Checked="True" oncheckedchanged="cbInsertLFAfterCR_CheckedChanged"></asp:CheckBox></P>
										</TD>
									</TR>
									<TR>
										<TD>
											<asp:CheckBox id="cbHostAnswerback" runat="server" Text="Host Answerback" Enabled="False"></asp:CheckBox></TD>
									</TR>
								</TABLE>
							</P>
						</TD>
            ...
            <asp:button id="buttonSave" style="Z-INDEX: 105; LEFT: 220px; POSITION: absolute; TOP: 528px"
				runat="server" Text="Save" Width="108px" Height="40px" onclick="buttonSave_Click"></asp:button>
