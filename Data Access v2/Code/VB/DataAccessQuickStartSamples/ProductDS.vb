...
Public Class ProductDS
    ...
    Public Class ProductsDataTable
        ...
        Public Overloads Function AddProductsRow(ByVal ProductID As Integer, ByVal ProductName As String, ByVal QuantityPerUnit As String, ByVal UnitPrice As Decimal) As ProductsRow
            Dim rowProductsRow As ProductsRow = CType(Me.NewRow,ProductsRow)
            rowProductsRow.ItemArray = New Object() {ProductID, ProductName, QuantityPerUnit, UnitPrice}
        ...
        Private Sub InitClass()
            ...
            Me.columnQuantityPerUnit.AllowDBNull = false
