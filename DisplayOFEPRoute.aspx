<%@ Page language="c#" Codebehind="DisplayOFEPRoute.aspx.cs" AutoEventWireup="True" validateRequest=false Inherits="ClientDeviceMgr.DisplayOFEPRoute" %>
...
<HTML>
	<HEAD>
		<title>Display OFEPRoute Configuration</title>
	...
	<body>
		<form id="OFEPRouteForm" method="post" runat="server">
            ...
            <asp:panel id="PanelDebug" style="Z-INDEX: 103; LEFT: 496px; POSITION: absolute; TOP: 506px"
				...
				<P>&nbsp;
					<asp:TextBox id="txtboxLogFilePath" runat="server" Width="226px" MaxLength="255" ToolTip="Enter the fully qualified path to where the logging information is to be output."></asp:TextBox></P>
				<P>&nbsp;&nbsp;
					<asp:Button id="btnDbgOK" runat="server" Width="58px" Text="OK" Enabled="False" Visible="False" onclick="btnDbgOK_Click"></asp:Button>&nbsp;
