...
namespace ClientDeviceMgr
{
	...
	/// </summary>
	public partial class DisplayPtrAEALiteDrv : Web.PageBase
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
            ...
            if( !Page.IsPostBack )
			{
				...
				CategoryDesciptionLabel.Text = wsName.Trim() + " AEALite Printer Information";
		...
		private void LoadCurrentConfiguration()
		{
			...
			try
			{
				DataSet dsDeviceInfo = database.MyFillDataSet(cmdSelectExistingDevices,configTable);
			...
			try
			{
				...
				if( newDevice )
				{
					...
					executionCommand += ( 
							...
							ConfigurePtr.COLUMN_LOG_FILE_NAME+ " , rowguid" + 
						" ) " +
						" VALUES ( '" +
							deviceName + "', '" +
							noOfFF + "', '" +
				...
				try
				{
					database.MyUpdateDataExecuteNonQuery(executionCommand);
				}
				catch(Exception ex )
				{
