...
namespace ClientDeviceMgr
{
	...
	/// </summary>
	public partial class DisplayRoute : Web.PageBase
	{
		...
		private const String HSSP_CONFIG_ROUTE_URL = "DisplayHsspRoute.aspx";
		private const String OFEP_CONFIG_ROUTE_URL = "DisplayOfepRoute.aspx";
		...
		{
            LoginIfNotLoggedIn();
            WSName = SelectWorkstationIfNoneSelected(); // or "UserWSSelect.aspx"
