...
<%@ Page language="c#" Codebehind="Emul.aspx.cs" AutoEventWireup="True" Inherits="ClientDeviceMgr.Emul" %>
...
<HTML>
	...
	<body>
		<form id="EmulCfg" method="post" runat="server">
			...
			<asp:Label id="lblMessage" style="Z-INDEX: 101; LEFT: 240px; POSITION: absolute; TOP: 96px"
				runat="server" Width="800px" Height="48px" ForeColor="Navy" Font-Bold="True" Font-Size="Larger"></asp:Label>
			<asp:Panel id="AutoPanel" style="Z-INDEX: 105; LEFT: 220px; POSITION: absolute; TOP: 432px"
				runat="server" Width="392px" Height="300px">
				<P>&nbsp;</P>
				<P>
					<asp:Label id="lblAutoLabel" runat="server" Width="312px" ForeColor="Navy" Font-Bold="True"
						Font-Size="Smaller">All profiles currently configured in the database:</asp:Label></P>
				<P>&nbsp;
			...
			<asp:Panel id="ManualPanel" style="Z-INDEX: 104; LEFT: 240px; POSITION: absolute; TOP: 248px"
				...
				<P>
					...
					&nbsp;<asp:Label id="lblManual" runat="server" Width="136px" ForeColor="Navy" Font-Bold="True" Font-Size="Smaller"
						ToolTip="Enter the workstation you wish to configure.">profile name</asp:Label>
                </P>
				<P>&nbsp;
			...
			<asp:RadioButton id="AutoSelection" style="Z-INDEX: 103; LEFT: 240px; POSITION: absolute; TOP: 208px"
			...
			<asp:RadioButton id="ManualSelection" style="Z-INDEX: 102; LEFT: 240px; POSITION: absolute; TOP: 168px"
			...
			<asp:Panel id="EmulPanel" style="Z-INDEX: 107; LEFT: 16px; POSITION: absolute; TOP: 976px"
                ...
                <P>
                    <em>Settings are in [Section]s as keyword=value entries, one per line</em><br />
                    <em>; Semicolon starting a line allows comments, which are not taken as settings.</em>
                </P>
				<P>&nbsp;
					<asp:TextBox id="txtboxEmulSettings" runat="server" Width="792px" Height="392px" Font-Bold="True"
						Font-Size="Small" Wrap="False" TextMode="MultiLine"></asp:TextBox></P>
				<P>&nbsp;
