...
namespace ClientDeviceMgr
{
	...
	/// </summary>
	public partial class OFEPRoute : Web.PageBase
	{
		...
		private string WebForm = "OFEPRoute";
		...
		private void InitDebugForm()
		{
			...
			{
                ckboxTraceActive.Checked = (Temp.Trim() == "1");
			}
		...
		private void InitBasicForm()
		{
			...
			Temp = RouteTable.Rows[0]["LNIATA"].ToString().Trim().ToUpper();
			if (!string.IsNullOrEmpty(Temp))
			{
			...
			Temp = RouteTable.Rows[0]["POOLCLASS"].ToString().Trim().ToUpper();
			if (!string.IsNullOrEmpty(Temp))
			{
		...
		private DataTable GetRouteDataSet()
		{
			...
			string cmd = "SELECT * FROM " + OFEP_ROUTE_INFO_TBL +
		...
		private bool UpdateConfigurationInformation()
		{
			...
			string RouteInsertcmd = "INSERT INTO " + OFEP_ROUTE_INFO_TBL +
				"(LNIATA,LB1,LB2,LBPORT,MAXLOGFILESIZE,LOGGING,LOGFILE,POOLCLASS,KEEPALIVE,RouteName," +
				"WSNAME)" +
				" VALUES('" + lniata.Trim() + "','" +
				LB1.Trim() + "','" + LB2.Trim() + "','" + LBPort.Trim() + "','" +
				maxlogfilesize.Trim() + "','" + logging.Trim() + "','" +
				logfile.Trim() + "','" + poolclass.Trim() + "','" +
				keepalive.Trim() + "','" +
				RouteName.Trim() + "','" + WSName.Trim() + "')";
			...
			string MainRouteInsertCmd = "INSERT INTO " + MAIN_ROUTE_INFO_TBL +
				...
				" VALUES('" + RouteName.Trim() + "','1','" + WSName.Trim() + "','OFEP')";
			...
			cmd = "UPDATE " + OFEP_ROUTE_INFO_TBL +
