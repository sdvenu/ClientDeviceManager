...
<%@ Page language="c#" Codebehind="SP_ResetUserPWD.aspx.cs" AutoEventWireup="True" Inherits="ClientDeviceMgr.SP_ResetUserPWD" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Reset user password Screen</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="ResetUserPWDForm" method="post" runat="server">
			...
			<TABLE id="Table1" style="Z-INDEX: 102; LEFT: 280px; POSITION: absolute; TOP: 192px" cellSpacing="0"
				...
				<TR>
					...
					<TD style="HEIGHT: 39px"><asp:button id="btnResetPwd" runat="server" Text="Reset password" onclick="btnResetPwd_Click"></asp:button></TD>
					<TD style="HEIGHT: 39px"></TD>
				</TR>
			</TABLE>
			...
			<asp:RequiredFieldValidator id="RFVUserID" style="Z-INDEX: 103; LEFT: 600px; POSITION: absolute; TOP: 200px"
				runat="server" ErrorMessage="User ID cannot be blank" ControlToValidate="txbUser"></asp:RequiredFieldValidator>
