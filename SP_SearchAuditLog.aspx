...
<%@ Page language="c#" Codebehind="SP_SearchAuditLog.aspx.cs" AutoEventWireup="True" Inherits="ClientDeviceMgr.SP_SearchAuditLog" %>
<%@ Register TagPrefix="Module" TagName="Header" Src="Headers/Header.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Search audit log Page</title>
	...
	<body>
		<form id="ChechAllTAs" method="post" runat="server">
			...
			<asp:Panel id="pnlOutput" style="Z-INDEX: 103; LEFT: 240px; POSITION: absolute; TOP: 120px"
				...
				<asp:DataGrid id="dgLog" runat="server" PagerStyle-Width="600px" AllowPaging="True" OnPageIndexChanged="PageIndexChanged"
			...
			<asp:Panel id="pnlInput" style="Z-INDEX: 104; LEFT: 240px; POSITION: absolute; TOP: 120px"
				...
				<TABLE id="Table1" style="WIDTH: 456px; HEIGHT: 109px" cellSpacing="0" cellPadding="0"
					...
					<TR>
						...
						<TD>
							<P>
								<asp:RadioButton id="rbWSName" runat="server" Text="By workstation" AutoPostBack="True" GroupName="ByType"
									Checked="True" oncheckedchanged="rbWSName_CheckedChanged"></asp:RadioButton><BR>
								<asp:RadioButton id="rbUser" runat="server" Text="By user ID" AutoPostBack="True" GroupName="ByType" oncheckedchanged="rbUser_CheckedChanged"></asp:RadioButton></P>
						</TD>
						<TD></TD>
					</TR>
					<TR>
					...
					<TR>
						...
						<TD>
							<asp:RequiredFieldValidator id="rfvSearchBy" runat="server" ErrorMessage="Cannot be blank" ControlToValidate="txbSearchBy"></asp:RequiredFieldValidator></TD>
						<TD></TD>
					</TR>
				</TABLE>
			</asp:Panel>
