...
<%@ Page language="c#" Codebehind="SP_SearchTA.aspx.cs" AutoEventWireup="True" Inherits="ClientDeviceMgr.SP_SearchTA" %>
	...
	<body>
		<form id="ChechAllTAs" method="post" runat="server">
			...
			<asp:Panel id="pnlOutput" style="Z-INDEX: 103; LEFT: 240px; POSITION: absolute; TOP: 120px"
				...
				<asp:DataGrid id="dgLog" runat="server" BorderColor="Gray" BorderWidth="3px" BorderStyle="Groove"
					OnPageIndexChanged="PageIndexChanged" AllowPaging="True" PagerStyle-Width="600px" PageSize="20" onselectedindexchanged="dgLog_SelectedIndexChanged">
			...
			<asp:Panel id="pnlInput" style="Z-INDEX: 104; LEFT: 240px; POSITION: absolute; TOP: 120px"
				...
				<TABLE id="Table1" style="WIDTH: 456px; HEIGHT: 109px" cellSpacing="0" cellPadding="0"
					...
					<TR>
						...
						<TD>
							<asp:TextBox id="txbSearchBy" runat="server" ontextchanged="txbSearchBy_TextChanged"></asp:TextBox></TD>
						<TD>
							<P>
