...
namespace ClientDeviceMgr
{
	...
	/// </summary>
	public partial class WSSelect : Web.PageBase
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
            ...
            if (!IsPostBack)
			{
				...
				if (Group == "USER")
				{
					lblMessage.Text = "Select the workstation to view.";
					//set the Tooltip text...
					lblMessage.ToolTip = "You must select a workstation to " +
                ...
                // Move all the panels from design position to run position.
		...
		protected void ManualSelection_CheckedChanged(object sender, System.EventArgs e)
		{
			if (ManualSelection.Checked == true)
			{
				...
				txtboxWSName.Text="";
				lblMessage.Text = "Enter the name of the workstation to work with.";
                txtboxWSName.Focus();
			}
            //else
            //{
            //    Session["Select"] ="Auto";
            //    lblManual.Text="City code or partial name";
            //    pnlStatus.Visible = false;
            //    AutoPanel.Visible = false;
            //    ManualPanel.Visible = true;
            //    //AutoPanel.Style["left"] = "220px";
				...
				if (!IsWorkstationValid(txtboxWSName.Text.Trim()))
				{
					if (Group == "ADMIN")
					{
						Msg =
							...
							" in the menu to add " + txtboxWSName.Text;
					}
					else
					{
						Msg =
		...
		protected void btnAuto_Click(object sender, System.EventArgs e)
		{
			...
			{
				lblMessage.Text =
                    "You must select a workstation name from the list" +
		...
		private bool IsWorkstationValid(string WSName)
		{
			...
			{
				System.Diagnostics.Trace.Write(excep, "WSSelect DB Error");
		...
		protected void txtboxWSName_TextChanged(object sender, System.EventArgs e)
		{
